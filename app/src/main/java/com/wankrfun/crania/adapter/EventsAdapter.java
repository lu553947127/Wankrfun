...
public class EventsAdapter extends BaseQuickAdapter<EventsBean.DataBean.ListBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, EventsBean.DataBean.ListBean item) {
        helper.setText(R.id.tv_title,item.getEvent_contents())
                ...
                .setText(R.id.tv_clock, item.getActivity_time().equals("2200-01-01T08:30:00.000Z") ? "不限时间" : NumberUtils.dealDateFormat(item.getActivity_time()))
                .setText(R.id.tv_clock2, item.getActivity_time().equals("2200-01-01T08:30:00.000Z") ? "不限时间" : NumberUtils.dealDateFormat(item.getActivity_time()))
