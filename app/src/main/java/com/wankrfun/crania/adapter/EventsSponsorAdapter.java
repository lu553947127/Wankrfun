 ...
 * @Package: com.wankrfun.crania.adapter
 * @ClassName: EventsSponsorAdapter
 * @Description: java类作用描述
 * @Author: 鹿鸿祥
 * @CreateDate: 1/27/21 2:41 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 1/27/21 2:41 PM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class EventsSponsorAdapter extends BaseQuickAdapter<EventsParticipantsBean.DataBean.ParticipantsBean, BaseViewHolder> {
    public EventsSponsorAdapter(int layoutResId, @Nullable List<EventsParticipantsBean.DataBean.ParticipantsBean> data) {
